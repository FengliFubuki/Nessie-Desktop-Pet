Create one horizontal look-direction strip for Codex pet `nessie`, atlas row 9.
...
REVISED CARDINAL BASIS: use the current approved cardinal strip, whose180 down pose now follows the same soft forward/right neck curl as the down-right family. The former tall central/left down pose is obsolete. Interpolate head location, height and snout pitch evenly toward this new180. 157.5 must be one small ordinary step before new180, keeping nose down-right;180 itself has a vertically downward snout. Keep total head displacement and shape change smooth, never overshoot and return abruptly. Preserve planted body, tail and flippers and original black bead eyes.
